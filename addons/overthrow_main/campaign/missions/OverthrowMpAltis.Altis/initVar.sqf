...
OT_NATO_StaticGarrison_LevelTwo = ["CFR_B_DSHKM_CDF", "CFR_B_DSHKM_CDF", "B_GMG_01_high_F", "B_MRAP_01_hmg_F"];
OT_NATO_StaticGarrison_LevelThree = ["B_Static_AT_F", "B_Static_AA_F", "CFR_B_DSHKM_CDF", "CFR_B_DSHKM_CDF", "B_GMG_01_high_F", "B_MRAP_01_hmg_F", "B_MRAP_01_gmg_F"];
