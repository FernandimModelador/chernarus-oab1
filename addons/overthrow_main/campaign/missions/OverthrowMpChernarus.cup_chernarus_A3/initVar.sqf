...
OT_NATO_Unit_Police = "CUP_B_CDF_Soldier_FST";
OT_NATO_Unit_Police_Heavy = "CUP_B_CDF_Soldier_RPG18_FST";
OT_NATO_Unit_PoliceMedic_Heavy = "CUP_B_CDF_Medic_FST";
OT_NATO_Vehicle_PoliceHeli = "CUP_B_Mi171Sh_Unarmed_ACR";
OT_NATO_Vehicle_Quad = "CUP_C_TT650_TK_CIV";
OT_NATO_Vehicle_Police = "CUP_B_UAZ_Unarmed_CDF";
